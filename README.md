...
<table>
    ...
    <tbody>
	    ...
	    <p>```Data reference```</p>: reading data from the connection destination of the function block’s input terminal.</br>
	    <p>```Data setting```</p>: writing data into the connection destination from the function block's output terminal.
	    </td>
        </tr>
        <tr>
