...
Key in  ```installutil C:\Solution_Folder\Solution_Name\bin\Debug\Solution_Name.exe```
	
	and press enter. You should see ```The Commit phase completed successfully. The transacted install has completed```
